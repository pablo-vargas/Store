...
import com.foxdigitaltech.store.ui.home.model.ProductCharacteristics;
...
public class HomeFragment extends Fragment implements HomeFragmentContract.View, ProductAdapter.Listener{
            ...
            public void onClick(View view) {
                ...
                for(ProductPropertyCart productPropertyCart: list){
                    if(productPropertyCart.isSelect()){
                        ...
                        addCart+= productPropertyCart.getProductCart().getProperty()+"\n";
                    }
                }
                if(!addCart.isEmpty()){
                    Toast.makeText(getContext(), "Productos\nAñadido correctamente.", Toast.LENGTH_SHORT).show();
                }
